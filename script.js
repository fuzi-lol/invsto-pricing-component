...
// let dark = document.getElementsById('buttondark');
// dark.addEventListener('click',function(){
//     dark.style.background="#FFF";
// });

let drm = document.getElementById("buttondark");
function myFunction(){
    let element = document.body;
    element.classList.toggle("darkmode");
    if(drm.innerHTML=="Light Mode"){
        drm.innerHTML="Dark Mode";
    }else{
        drm.innerHTML="Light Mode";
    }
